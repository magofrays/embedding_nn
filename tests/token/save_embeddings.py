...
model100.save_word_count("../../src_data/token/word_count_100.json")

# model500 = word2vec(500, 6, 2)
# model500.add_data(learning_data)
# model500.train()
# model500.save_embeddings("../../src_data/token/emb_token_500.json")
# model100.save_word_count("../../src_data/token/word_count_500.json")
...
# model100.save_word_count("../../src_data/token/word_count_1000.json")
